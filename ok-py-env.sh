...
sudo apt-get -y install python ipython ipython3 python-pip python3-pip virtualenv virtualenvwrapper vim curl nodejs npm git ssh docker.io phantomjs mongodb mysql-server mysql-client libmysqlclient-dev
