...
sudo apt-get -y install ipython3 python3-pip virtualenv virtualenvwrapper vim curl git ssh phantomjs mongodb  mysql-server mysql-client libmysqlclient-dev
